...
final class ZixyTermsController: UIViewController {
    ...
    Welcome to Zixy! To make a better place, the following content is not allowed in the app in particular:
    ...
    If we find any content including and not limited to the above violations, your content will be deleted and your account will be banned. By clicking the above button, you agree to the Terms of Use and Privacy Policy.
    """
}
