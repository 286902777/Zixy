...
enum ZixyImageLibrary {
    ...
    static let myRoomDelete = UIImage(named: "zixy_my_room_delete")
    static let myRoomRemoveCover = UIImage(named: "zixy_my_room_remove_cover")
    static let myRoomCover = UIImage(named: "zixy_my_room_cover")
    static let followersAdd = UIImage(named: "zixy_followers_add")
    static let profileRemove = UIImage(named: "zixy_profile_remove")
    static let otherProfileFollowIcon = UIImage(
        named: "zixy_other_profile_follow_icon"
    )
    static let otherProfileMoreIcon = UIImage(
        named: "zixy_other_profile_more_icon"
    )
    static let rechargeBalanceBanner = UIImage(
        named: "zixy_recharge_balance_banner"
    )
    static let rechargeCoinStack = UIImage(named: "zixy_recharge_coin_stack")
    ...
    static let videoCommentBadge = UIImage(named: "zixy_video_comment_badge")
    static let releaseAddPhoto = UIImage(named: "zixy_release_add_photo")
    static let releaseClose = UIImage(named: "zixy_release_close")
    static let releaseRemovePhoto = UIImage(
        named: "zixy_release_remove_photo"
    )
    static let feedWoodMountain = UIImage(named: "zixy_feed_wood_mountain")
    static let reportCheckmark = UIImage(named: "zixy_report_checkmark")
    static let roomBackground = UIImage(named: "zixy_room_background")
    static let roomMoreButton = UIImage(named: "zixy_room_more_button")
    static let roomMicrophoneActive = UIImage(
        named: "zixy_room_microphone_active"
    )
    static let roomMicrophoneMuted = UIImage(
        named: "zixy_room_microphone_muted"
    )
    static let roomGift = UIImage(named: "zixy_room_gift")
    static let roomSend = UIImage(named: "zixy_room_send")
    static let roomStorePanel = UIImage(named: "zixy_room_store_panel")
    static let roomCoinStack = UIImage(named: "zixy_room_coin_stack")
    static let roomGiftGraver = UIImage(named: "zixy_room_gift_graver")
    static let roomGiftInkPad = UIImage(named: "zixy_room_gift_ink_pad")
    static let roomGiftCarving = UIImage(named: "zixy_room_gift_carving")
    static let roomGiftToolkit = UIImage(named: "zixy_room_gift_toolkit")
    static let roomGiftBrush = UIImage(named: "zixy_room_gift_brush")
    static let roomGiftWorkbench = UIImage(
        named: "zixy_room_gift_workbench"
    )
    static let roomGiftHandsaw = UIImage(named: "zixy_room_gift_handsaw")
    static let roomGiftRuler = UIImage(named: "zixy_room_gift_ruler")
    static let callBackground = UIImage(named: "zixy_call_background")
    static let callAvatar = UIImage(named: "zixy_call_avatar")
    static let callEnd = UIImage(named: "zixy_call_end")
    ...
    static let chatPhotoAction = UIImage(named: "zixy_chat_photo_action")
    static let chatVideoCallAction = UIImage(
        named: "zixy_chat_video_call_action"
    )
